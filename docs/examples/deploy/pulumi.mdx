...
[Pulumi](https://www.pulumi.com/) is an open-source infrastructure as code tool that allows you to create, deploy, and manage cloud infrastructure using familiar programming languages.
...
| Name    | Description                            |
| ------- | -------------------------------------- |
| setup   | Installs a specific version of Pulumi. |
| preview | Preview changes to a stack.            |
| up      | Create or update a stack.              |
...
dag().call(
  "https://pkg.fluentci.io/pulumi@v0.1.0?wasm=1",
  "preview",
  vec!["--stack", "dev"],
)?;
