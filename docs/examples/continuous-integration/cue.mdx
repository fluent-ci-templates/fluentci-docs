...
[CUE](https://cuelang.org/) is an open source language, with a rich set of APIs and tooling, for defining, generating, and validating all kinds of data: configuration, APIs, database schemas, code... you name it.
...
| ----- | ------------------------------- |
| setup | Install cue.                    |
| fmt   | Format CUE configuration files. |
